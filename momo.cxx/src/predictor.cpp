...
#ifdef MOMO_TRACE
    { auto _t1 = TRACE_NOW(); tr_vocab = TRACE_US(_t0, _t1); }
#endif
...
#ifdef MOMO_TRACE
        { auto _t1 = TRACE_NOW(); tr_fill += TRACE_US(_t0, _t1); _t0 = _t1; }
#endif
        compute_read_scores(all_feat_ids[i], int_scores);
#ifdef MOMO_TRACE
        { auto _t1 = TRACE_NOW(); tr_read_scores += TRACE_US(_t0, _t1); _t0 = _t1; }
#endif
...
#ifdef MOMO_TRACE
        { auto _t1 = TRACE_NOW(); tr_scale += TRACE_US(_t0, _t1); _t0 = _t1; }
#endif
...
#ifdef MOMO_TRACE
        { auto _t1 = TRACE_NOW(); tr_boundary += TRACE_US(_t0, _t1); _t0 = _t1; }
#endif
...
#ifdef MOMO_TRACE
    const long long tr_total = tr_utf8 + tr_seq + tr_feat_key + tr_vocab
                             + tr_fill + tr_read_scores + tr_scale + tr_boundary;
    std::fprintf(stderr,
        ...
        "  boundary           %6lld ns\n",
        n, tr_total,
        tr_utf8, tr_seq, tr_feat_key, tr_vocab,
        tr_fill, tr_read_scores, tr_scale, tr_boundary);
#endif
