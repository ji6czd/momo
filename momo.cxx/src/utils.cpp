...
const char* char_type_to_str(CharType ct) {
  switch (ct) {
    ...
    case CharType::JAPANESE_NUMERIC:
...
CharType get_basic_char_category(char32_t cp) {
  ...
  if ((cp >= 0x0041 && cp <= 0x005A) || (cp >= 0x0061 && cp <= 0x007A) || (cp >= 0xFF21 && cp <= 0xFF3A) ||
      (cp >= 0xFF41 && cp <= 0xFF5A))
    return CharType::ALPHA;
  return CharType::OTHER;
}
...
bool has_vowel(char32_t char_cp, char32_t vowel_cp) {
  ...
  static const std::unordered_map<char32_t, char32_t> vowel_map = {
      {U'ア', U'ア'}, {U'イ', U'イ'}, {U'ウ', U'ウ'}, {U'エ', U'エ'}, {U'オ', U'オ'}, {U'ァ', U'ア'}, {U'ィ', U'イ'},
      {U'ゥ', U'ウ'}, {U'ェ', U'エ'}, {U'ォ', U'オ'}, {U'カ', U'ア'}, {U'キ', U'イ'}, {U'ク', U'ウ'}, {U'ケ', U'エ'},
      {U'コ', U'オ'}, {U'ガ', U'ア'}, {U'ギ', U'イ'}, {U'グ', U'ウ'}, {U'ゲ', U'エ'}, {U'ゴ', U'オ'}, {U'サ', U'ア'},
      {U'シ', U'イ'}, {U'ス', U'ウ'}, {U'セ', U'エ'}, {U'ソ', U'オ'}, {U'ザ', U'ア'}, {U'ジ', U'イ'}, {U'ズ', U'ウ'},
      {U'ゼ', U'エ'}, {U'ゾ', U'オ'}, {U'タ', U'ア'}, {U'チ', U'イ'}, {U'ツ', U'ウ'}, {U'テ', U'エ'}, {U'ト', U'オ'},
      {U'ダ', U'ア'}, {U'ヂ', U'イ'}, {U'ヅ', U'ウ'}, {U'デ', U'エ'}, {U'ド', U'オ'}, {U'ナ', U'ア'}, {U'ニ', U'イ'},
      {U'ヌ', U'ウ'}, {U'ネ', U'エ'}, {U'ノ', U'オ'}, {U'ハ', U'ア'}, {U'ヒ', U'イ'}, {U'フ', U'ウ'}, {U'ヘ', U'エ'},
      {U'ホ', U'オ'}, {U'バ', U'ア'}, {U'ビ', U'イ'}, {U'ブ', U'ウ'}, {U'ベ', U'エ'}, {U'ボ', U'オ'}, {U'パ', U'ア'},
      {U'ピ', U'イ'}, {U'プ', U'ウ'}, {U'ペ', U'エ'}, {U'ポ', U'オ'}, {U'マ', U'ア'}, {U'ミ', U'イ'}, {U'ム', U'ウ'},
      {U'メ', U'エ'}, {U'モ', U'オ'}, {U'ヤ', U'ア'}, {U'ユ', U'ウ'}, {U'ヨ', U'オ'}, {U'ャ', U'ア'}, {U'ュ', U'ウ'},
      {U'ョ', U'オ'}, {U'ラ', U'ア'}, {U'リ', U'イ'}, {U'ル', U'ウ'}, {U'レ', U'エ'}, {U'ロ', U'オ'}, {U'ワ', U'ア'},
      {U'ヲ', U'オ'}, {U'ヴ', U'ウ'},
  };
